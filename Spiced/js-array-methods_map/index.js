...
const questionsAndAnswersTogether = cards.map((card) => card.answer.question);
...
console.log(questionAndAnswer); // [{ question: 'How often can I use <header>?', answer: 'As often as you like.'}, {...}]
